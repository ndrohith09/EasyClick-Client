  ...
  render() { 
    ...
    return (
      <DefaultLayout>
        ...
        <Flex minWidth="max-content" alignItems="center" gap="2">
            ...
            <ButtonGroup gap="2">
              ...
              <WhatsappShareButton
              title={`Check out this ${group_data.industry} subscription`}
            url={group_data.api_endpoints}
            quote={group_data.industry} 
          >
      ...
      <Heading size="xs" style={{'marginBottom':'25px', 'color' :"#4A5568" , 'fontWeight' : 'normal' , 'textTransform' : 'uppercase'}}>{plan.subscription_plan_data.name}</Heading>
          <Text fontWeight="bold" color="#4A5568" fontSize="3xl" mb="24px" display="inline">$ {plan.subscription_plan_data.phases[0].recurring_price_money.amount / 100}<Text fontSize="sm" display="inline">/{plan.subscription_plan_data.phases[0].cadence}</Text></Text>
          ...
          <Button  
          style={{'backgroundColor' :'#3C50E0' , 'color' : "#fff" , 'borderRadius' :'7px', 'fontSize' :'14px'}} px="8" my="5">Purchase</Button>
